...
import type { Customer, Service, ServiceCategory, Staff, Appointment, Invoice, InvoiceItem, Product, MembershipPlan, Review, Notification, AIInsight, RevenueDataPoint, DashboardStats, Campaign, LoyaltyTransaction, Expense, AuditLog, StaffSchedule, TenantPlan, TenantStatus, Tenant } from '@/lib/types'
